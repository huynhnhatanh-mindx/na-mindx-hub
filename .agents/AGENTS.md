...
## 1. Không tự ý thêm/bớt dữ liệu mẫu
- **KHÔNG** thêm, sửa, hoặc xóa dữ liệu mẫu (mock data, seed data, placeholder content) khi chưa được người dùng đồng ý rõ ràng.
- Nếu cần dữ liệu mẫu, phải hỏi ý kiến trước và chờ phê duyệt.
